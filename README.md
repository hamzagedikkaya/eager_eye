<table>
  <tr>
    <td valign="top" width="140">
      <img src="images/icon.png" alt="EagerEye Logo" width="120">
    </td>
    <td valign="top">
      <h1 style="margin: 0;">EagerEye</h1>
      <p><strong>Static analysis tool for detecting N+1 queries in Rails applications.</strong></p>
      <p>
